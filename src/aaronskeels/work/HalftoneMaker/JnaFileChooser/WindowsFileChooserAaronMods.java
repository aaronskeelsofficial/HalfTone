package aaronskeels.work.HalftoneMaker.JnaFileChooser;
...
*/
public class WindowsFileChooserAaronMods
{
	 ...
	 */
	public WindowsFileChooserAaronMods() {
	 ...
	 */
	public WindowsFileChooserAaronMods(File currentDirectory) {
		filters = new ArrayList<String[]>();
	 ...
	 */
	public WindowsFileChooserAaronMods(String currentDirectoryPath) {
	...
	boolean showDialog(Window parent, boolean open) {
		...
		} else if (!open && !defaultFilename.isEmpty()) { //Aaron added this. Why would saving not allow default filename functionality?
			params.lpstrFile.setWideString(0, defaultFilename);
		} else {
