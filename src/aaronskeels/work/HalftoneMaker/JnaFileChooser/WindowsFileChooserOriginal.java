...
*/
public class WindowsFileChooserOriginal
{
	 ...
	 */
	public WindowsFileChooserOriginal() {
	 ...
	 */
	public WindowsFileChooserOriginal(File currentDirectory) {
		filters = new ArrayList<String[]>();
	 ...
	 */
	public WindowsFileChooserOriginal(String currentDirectoryPath) {
